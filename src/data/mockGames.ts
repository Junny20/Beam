...
export const friendsData: Friend[] = [
  { id: 1, name: 'CosmicExplorer', avatar: 'CE', status: 'playing', currentGame: "Baldur's Gate 3", playtime: 342 },
  { id: 2, name: 'SteamWizard', avatar: 'SW', status: 'online', currentGame: 'Hades II', playtime: 89 },
  { id: 3, name: 'GalaxyMapper', avatar: 'GM', status: 'offline', playtime: 156 },
  { id: 4, name: 'AchievementHunter', avatar: 'AH', status: 'playing', currentGame: 'Elden Ring', playtime: 289 },
  { id: 5, name: 'GameCollector', avatar: 'GC', status: 'online', playtime: 78 },
  { id: 6, name: 'PixelPioneer', avatar: 'PP', status: 'offline', playtime: 45 },
];
...
export function getFriendsWhoPlayedRecently(_gameId: number): Friend[] {
  return friendsData.filter(f => f.status === 'playing' || f.status === 'online');
}
