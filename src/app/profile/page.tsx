                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            <div className="shrink-0">
                                ...
                                <div className="mt-4 flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-800/50 border border-slate-700/50 w-fit">
                                    <span
                                        className={`w-2 h-2 rounded-full ${status.dot} ring-2 ring-slate-900`}
                                    />
                            ...
                            <div className="flex-1 min-w-0 space-y-6">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-slate-800 text-slate-200 font-medium text-sm hover:bg-slate-700 transition-colors border border-slate-700 cursor-pointer"
                                    >
                                        <svg
                                            className="w-4 h-4"
                                            fill="none"
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-4 border-b border-slate-800/50">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">
                        Total gaming statistics across your library
                    </p>
                </div>
                <div className="text-left sm:text-right">
                    <p className="text-3xl font-bold text-white tabular-nums tracking-tight">
                        {totalHours.toLocaleString()}
                        <span className="text-lg font-medium text-slate-500 ml-1.5">
                            hrs
                        </span>
                    </p>
